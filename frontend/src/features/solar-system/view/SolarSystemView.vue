...
defineExpose({
  ...
  loadSpacecraft: (data) => controller.value?.loadSpacecraft(data),
  focusSpacecraft: (id) => controller.value?.focusSpacecraft(id),
  clearSpacecraft: () => controller.value?.clearSpacecraft(),
});
</script>
