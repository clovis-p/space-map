 ...
 * Position is propagated from Keplerian orbital elements sourced from CelesTrak OMM records or JPL Horizons.
 *
 ...
 * to get the spacecraft's position in the solar system frame.
 */
export class Spacecraft extends SpaceObject {
  /**
   * @param {object} params
   * @param {string} params.id NORAD catalog number or Horizons ID
  ...
  constructor({ id, name, centralBodyId, elements }) {
    super({ id, name, type: 'spacecraft', displayMode: 'icon' });
